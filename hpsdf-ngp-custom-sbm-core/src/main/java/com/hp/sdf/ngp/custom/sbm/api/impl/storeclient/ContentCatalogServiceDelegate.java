...
import com.hp.sdf.ngp.custom.sbm.storeclient.service.ContentCatalogServiceImpl;

@Component(value = "contentCatalogService")
public class ContentCatalogServiceDelegate extends ComponentDelegate<ContentCatalogService> implements ContentCatalogService {

	@SuppressWarnings("unchecked")
	@Override
	protected Class<ContentCatalogService> getDefaultComponent() {
		return (Class) ContentCatalogServiceImpl.class;

	}

	@PostConstruct
	protected void init() {
		JndiUtil.bind(ContentCatalogService.class.getCanonicalName(), this);
	}
	...
	public Long addContentItem(ContentItem contentItem) throws AssetCatalogServiceException {
		return this.component.addContentItem(contentItem);
	}
	...
	public int callDatabaseProcedure(String procedureName, List<Object> parameters) throws AssetCatalogServiceException {
		return this.component.callDatabaseProcedure(procedureName, parameters);
	}
	...
	public ContentItem constructContentItem() throws AssetCatalogServiceException {
		return this.component.constructContentItem();
	}
	...
	public void deleteContentItem(Long itemId) throws AssetCatalogServiceException {
		this.component.deleteContentItem(itemId);
	}
	...
	public Map<String, Date> generateBinaryVersionIndex(List<String> excludeStatus, String source, String updateDateEavAttrName) throws AssetCatalogServiceException {
		return this.component.generateBinaryVersionIndex(excludeStatus, source, updateDateEavAttrName);
	}
	...
	// public void setRestrictionTypes(Long assetId, Set<Long> restrictionTypeIds) throws AssetCatalogServiceException {
	// this.component.setRestrictionTypes(assetId, restrictionTypeIds);
	// }
	...
	public void updateContentItem(ContentItem contentItem) throws AssetCatalogServiceException {
		this.component.updateContentItem(contentItem);
	}
	...
	public void recordAssetDownloadHistory(String userId, Long assetId, String version) throws AssetCatalogServiceException {
