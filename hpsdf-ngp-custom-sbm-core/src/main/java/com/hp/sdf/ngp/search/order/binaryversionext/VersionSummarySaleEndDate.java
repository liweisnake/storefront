...
@Component
public class VersionSummarySaleEndDate extends BaseOrderExecutor {

	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder( orderEnum, "saleEnd");
	}

	@Override
	protected OrderBy getOrderBy() {

		return BinaryVersionOrderByExt.VERSIONSUMMARY_SALEENDDATE;
	}
}
