...
@Component
public class VersionSummaryDownloadTime extends BaseOrderExecutor {

	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder( orderEnum, "downloadTime");
	}

	@Override
	protected OrderBy getOrderBy() {

		return BinaryVersionOrderByExt.VERSIONSUMMARY_DOWNLOADTIME;
	}
}
