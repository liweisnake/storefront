...
@Component
public class VersionSummaryLowestPrice extends BaseOrderExecutor {

	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder( orderEnum, "lowestPrice");
	}

	@Override
	protected OrderBy getOrderBy() {

		return BinaryVersionOrderByExt.VERSIONSUMMARY_LOWESTPRICE;
	}
}
