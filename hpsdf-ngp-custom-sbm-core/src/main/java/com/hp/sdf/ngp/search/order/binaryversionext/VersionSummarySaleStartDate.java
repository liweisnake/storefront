...
@Component
public class VersionSummarySaleStartDate extends BaseOrderExecutor {


	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder( orderEnum, "saleStart");
	}

	@Override
	protected OrderBy getOrderBy() {

		return BinaryVersionOrderByExt.VERSIONSUMMARY_SALESTARTDATE;
	}
}
