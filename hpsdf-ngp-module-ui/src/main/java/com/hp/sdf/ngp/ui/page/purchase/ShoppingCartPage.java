...
public class ShoppingCartPage extends WicketPage {

	public ShoppingCartPage(PageParameters parameters) {
		super(parameters);

		BreadCrumbBar breadCrumbBar = new BreadCrumbBar("breadCrumbBar");
		add(breadCrumbBar);
		ShoppingCartPanel shoppingCartPanel = 
			new ShoppingCartPanel("shoppingCartPanel", breadCrumbBar);
