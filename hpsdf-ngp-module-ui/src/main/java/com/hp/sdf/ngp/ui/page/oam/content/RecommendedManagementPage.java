...
public class RecommendedManagementPage extends WicketPage {
	public RecommendedManagementPage(PageParameters parameters) {
		super(parameters);
		BreadCrumbBar breadCrumbBar = new BreadCrumbBar("breadCrumbBar");
		add(breadCrumbBar);
		breadCrumbBar.setVisible(false);
		RecommendedManagementPanel contentManagementPanel = new RecommendedManagementPanel("recommendedManagementPanel", breadCrumbBar);
