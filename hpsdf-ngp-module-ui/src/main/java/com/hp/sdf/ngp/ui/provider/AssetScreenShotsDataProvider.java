...
public class AssetScreenShotsDataProvider implements IDataProvider<ScreenShots> {
	...
	public AssetScreenShotsDataProvider(ApplicationService applicationService) {
		this.applicationService = applicationService;
	}

	public AssetScreenShotsDataProvider(ApplicationService applicationService, Long assetId) {
		this.applicationService = applicationService;
