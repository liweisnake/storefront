...
import com.hp.sdf.ngp.ais.ui.page.banner.view.BannerSelectPage;
...
@Component
public class BannerViewApplication extends WicketApplication {
	...
	public Class<Page> getHomePage() {
	    ...
	    if (PortletMode.EDIT.equals(prc.getPortletRequest().getPortletMode())){ 
			return (Class)BannerSelectPage.class; 
	    } 
	    return (Class)BannerViewPage.class; 
	}
