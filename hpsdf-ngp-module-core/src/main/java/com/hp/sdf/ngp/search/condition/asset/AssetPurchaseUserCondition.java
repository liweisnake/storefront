...
public class AssetPurchaseUserCondition extends JoinPropertyCondition {
	
	public AssetPurchaseUserCondition(String value,
			StringComparer matchType, boolean ignorecase,
			boolean isWildCard) {
		super("purchaseHistorys", new StringPropertyCondition(
