...
public class AssetStatusNameCondition extends JoinPropertyCondition {

	public AssetStatusNameCondition(String value, StringComparer matchType,
			boolean ignorecase, boolean isWildCard) {
		super("status", new StringPropertyCondition("status.status", value, matchType,
