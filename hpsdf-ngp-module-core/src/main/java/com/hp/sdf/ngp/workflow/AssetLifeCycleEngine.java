...
public interface AssetLifeCycleEngine extends WorkFlowEngine {

	/**
	 * Get the privilege string for a particular type for a app id 
	 * @param accessType
	 * @return
	 * @throws WorkFlowFailureException
	 */
	public String[] getAccessPrivilege(long assetId,AccessType accessType)throws WorkFlowFailureException;
