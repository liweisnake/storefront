...
public class AssetAuthoridCondition extends StringPropertyCondition {

	public AssetAuthoridCondition(String value,
			StringComparer matchType, boolean ignorecase, boolean isWildCard) {
		super("authorid", value, matchType, ignorecase, isWildCard);
	}
