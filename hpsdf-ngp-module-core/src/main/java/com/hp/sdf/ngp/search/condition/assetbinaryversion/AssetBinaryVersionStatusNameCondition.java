...
public class AssetBinaryVersionStatusNameCondition extends JoinPropertyCondition {

	public AssetBinaryVersionStatusNameCondition(String value,
			StringComparer matchType, boolean ignorecase,
			boolean isWildCard) {
		super("status",
				new StringPropertyCondition(
						"status.status", value, matchType,
