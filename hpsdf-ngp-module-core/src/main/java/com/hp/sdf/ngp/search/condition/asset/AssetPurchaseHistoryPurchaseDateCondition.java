...
public class AssetPurchaseHistoryPurchaseDateCondition extends
		JoinPropertyCondition {

	public AssetPurchaseHistoryPurchaseDateCondition(Date value,
			DateComparer matchType) {
		super("purchaseHistorys", new DatePropertyCondition(
				"purchaseHistorys.purchaseDate", value, matchType));
	}
