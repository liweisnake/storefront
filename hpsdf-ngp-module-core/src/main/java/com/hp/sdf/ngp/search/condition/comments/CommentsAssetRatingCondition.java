...
public class CommentsAssetRatingCondition extends JoinPropertyCondition {

	public CommentsAssetRatingCondition(Double value,
			NumberComparer matchType) {
		super("asset", new NumberPropertyCondition("asset.averageUserRating",value,matchType));
	}
