...
public class AssetParentOnlyCondition extends ObjectPropertyCondition {

	public AssetParentOnlyCondition() {
		condition = new NumberPropertyCondition("id", null, NumberComparer.NULL);
	}
