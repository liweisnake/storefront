 ...
 */
package com.hp.sdf.ngp.search.order.category;
...
@Component
public class CategoryParentExternalId extends BaseOrderExecutor {

	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder( orderEnum, "parentCategory.externalId");
	}

	@Override
	protected OrderBy getOrderBy() {

		return CategoryOrderBy.PARENTEXTERNALID;
	}
