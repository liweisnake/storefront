...
@Component
public class BinaryVersionProviderPriority extends BaseOrderExecutor {

	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder(orderEnum, "asset.assetProvider.priority");
	}

	@Override
	protected OrderBy getOrderBy() {

		return BinaryVersionOrderBy.PROVIDERPRIORITY;
	}
}
