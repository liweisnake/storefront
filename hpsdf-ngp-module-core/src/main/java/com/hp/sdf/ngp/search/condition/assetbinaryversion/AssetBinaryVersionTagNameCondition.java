...
public class AssetBinaryVersionTagNameCondition extends JoinPropertyCondition{

	public AssetBinaryVersionTagNameCondition(String value,
			StringComparer matchType, boolean ignorecase,
			boolean isWildCard) {
		super("assetTagRelations.tag",
				new StringPropertyCondition(
						"tag.name", value, matchType,
