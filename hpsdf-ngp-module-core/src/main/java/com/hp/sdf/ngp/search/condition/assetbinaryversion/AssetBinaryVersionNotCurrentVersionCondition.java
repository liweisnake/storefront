...
public class AssetBinaryVersionNotCurrentVersionCondition extends
		ObjectPropertyCondition {

	public AssetBinaryVersionNotCurrentVersionCondition() {
		super((BaseCondition) new AssetBinaryVersionCurrentVersionCondition()
				.not());
	}
}
