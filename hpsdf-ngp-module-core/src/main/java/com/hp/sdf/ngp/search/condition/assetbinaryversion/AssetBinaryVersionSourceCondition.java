...
public class AssetBinaryVersionSourceCondition  extends JoinPropertyCondition {
	
	public AssetBinaryVersionSourceCondition(String value,
			StringComparer matchType, boolean ignorecase,
			boolean isWildCard) {
		super("asset",
				new StringPropertyCondition(
						"asset.source", value, matchType,
