 ...
 */
package com.hp.sdf.ngp.search.order.userprofile;
...
@Component
public class UserProfileUserid extends BaseOrderExecutor {

	public void execute(OrderBy orderBy, OrderEnum orderEnum,
			SearchExpressionImpl expression) {
		expression.addOrder(orderEnum, "userid");
	}

	@Override
	protected OrderBy getOrderBy() {

		return UserProfileOrderBy.USERID;
	}
}
