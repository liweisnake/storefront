...
public class AssetTagDescriptionCondition extends JoinPropertyCondition {

	public AssetTagDescriptionCondition(String value,
			StringComparer matchType, boolean ignorecase,
			boolean isWildCard) {
		super("assetTagRelations.tag", new StringPropertyCondition(
				"tag.description", value, matchType, ignorecase,
				isWildCard));
	}
