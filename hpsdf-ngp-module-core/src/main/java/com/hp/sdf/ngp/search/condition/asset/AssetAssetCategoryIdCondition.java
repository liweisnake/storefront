...
public class AssetAssetCategoryIdCondition extends ObjectPropertyCondition {

	public AssetAssetCategoryIdCondition(Long value, NumberComparer matchType) {
		this.conditionType = ConditionType.join;
		JoinPropertyCondition joinCondition = new JoinPropertyCondition(
				"assetCategoryRelations.category", new NumberPropertyCondition(
						"category.id", value, matchType), false);
