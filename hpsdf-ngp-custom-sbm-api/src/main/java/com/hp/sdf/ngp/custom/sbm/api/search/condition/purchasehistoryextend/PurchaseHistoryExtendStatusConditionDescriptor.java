...
public class PurchaseHistoryExtendStatusConditionDescriptor extends StringConditionDescriptor {

	public PurchaseHistoryExtendStatusConditionDescriptor(String status,
			StringComparer matchType, boolean ignorecase, boolean isWildCard) {
		super(status, matchType, ignorecase, isWildCard);
	}
