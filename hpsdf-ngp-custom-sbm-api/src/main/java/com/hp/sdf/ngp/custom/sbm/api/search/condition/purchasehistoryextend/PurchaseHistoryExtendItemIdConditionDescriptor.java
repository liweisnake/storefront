...
public class PurchaseHistoryExtendItemIdConditionDescriptor extends NumberConditionDescriptor<Long> {

	public PurchaseHistoryExtendItemIdConditionDescriptor(Long itemId,
			NumberComparer matchType) {
		super(itemId, matchType);
	}
