...
public class ContentItemAssetIdConditionDescriptor extends NumberConditionDescriptor<Long> {

	public ContentItemAssetIdConditionDescriptor(Long assetId,NumberComparer matchType){
		super(assetId, matchType);
	}
}
