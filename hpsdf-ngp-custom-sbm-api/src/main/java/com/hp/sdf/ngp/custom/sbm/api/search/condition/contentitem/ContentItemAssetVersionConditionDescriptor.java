...
/**
 * Not implemented, only for design by req of DDC.
 * 
 *
 */
public class ContentItemAssetVersionConditionDescriptor extends StringConditionDescriptor {

	// TBD. 
	public ContentItemAssetVersionConditionDescriptor(String version,
			StringComparer matchType, boolean ignorecase, boolean isWildCard) {
		super(version, matchType, ignorecase, isWildCard);
	}
