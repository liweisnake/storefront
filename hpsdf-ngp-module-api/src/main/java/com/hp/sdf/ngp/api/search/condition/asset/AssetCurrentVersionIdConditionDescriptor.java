...
public class AssetCurrentVersionIdConditionDescriptor extends NumberConditionDescriptor<Long> {

	public AssetCurrentVersionIdConditionDescriptor(Long currentVersionId,
			NumberComparer matchType) {
		super(currentVersionId, matchType);		
	}
}
