...
public class AssetParentIdConditionDescriptor extends NumberConditionDescriptor<Long>  {

	public AssetParentIdConditionDescriptor(Long parentId,
			NumberComparer matchType) {
		super(parentId, matchType);		
	}
}
