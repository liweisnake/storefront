...
public class AssetBinaryVersionProviderCommissionRateConditionDescriptor extends NumberConditionDescriptor<Double> {

	public AssetBinaryVersionProviderCommissionRateConditionDescriptor(Double value,
