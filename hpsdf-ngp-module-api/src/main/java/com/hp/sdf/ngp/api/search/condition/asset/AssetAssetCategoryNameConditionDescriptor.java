...
/**
 * Search asset by its belong category name
 * 
 *
 */
public class AssetAssetCategoryNameConditionDescriptor extends StringConditionDescriptor {

	public AssetAssetCategoryNameConditionDescriptor(String value,
